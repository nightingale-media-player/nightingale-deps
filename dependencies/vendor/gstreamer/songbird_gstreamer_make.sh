...
################################################################################
#
# Script for building gstreamer (core)
#
################################################################################
################################################################################
...
build()
{
    ...
    if [ "$sys_name" = "Darwin" ]; then
        ...
        install_name_tool                                                            \
            ...
            ${dep_arch_dir}/${tgt_name}/${build_type}/lib/gstreamer-0.10/libgstcoreelements.so
        install_name_tool                                                            \
            -change                                                                  \
              ${dep_arch_dir}/${tgt_name}/${build_type}/lib/libgstbase-0.10.0.dylib\
        ...
        install_name_tool                                                            \
            -change                                                                  \
              ${dep_arch_dir}/${tgt_name}/${build_type}/lib/libgstreamer-0.10.0.dylib\
              libgstreamer-0.10.dylib                                                \
            ${dep_arch_dir}/${tgt_name}/${build_type}/lib/gstreamer-0.10/libgstcoreindexers.so
    fi
