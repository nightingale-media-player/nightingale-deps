...
build()
{
	...
	if [ "$sys_name" = "Darwin" ]; then
        ...
        tgt_dep_dir="${PKG_CONFIG_PATH}:${dep_arch_dir}/liboil/${build_type}"
	...
	export CFLAGS="${CFLAGS} -DWIN32 -D__NO_CTYPE -D_CRT_SECURE_NO_WARNINGS  -DHAVE_WIN32 -D_WINDOWS -wd4820 -wd4668 -wd4100 -wd4706 -wd4127 -wd4255 -wd4710 -wd4055 -D_MBCS -D_USRDLL -DCOBJMACROS -D_WIN32_DCOM -EHsc"
