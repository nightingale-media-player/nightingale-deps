...
nsXFormsSetFocusElement::HandleSingleAction(nsIDOMEvent* aEvent,
                                            nsIXFormsActionElement *aParentAction)
{
  // The control's ID can come from the value attribute of the child
  // 'control' element, the string-value of the child 'control'
  // element, or the control attribute of the setfocus
