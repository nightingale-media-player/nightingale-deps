...
function run_test() {
  ...
  var testDir = gDirSvc.get("CurWorkD", AUS_Ci.nsILocalFile);
  ...
  testFile = do_get_file(REL_TEST_PATH + "data/aus-0110_general_ref_image1.png");
  ...
  var updatesSubDir = gTestRoot.clone();
  ...
  var mar = do_get_file(REL_TEST_PATH + "data/aus-0110_general-2.mar");
  ...
  var refImage = do_get_file(REL_TEST_PATH + "data/aus-0110_general_ref_image2.png");
